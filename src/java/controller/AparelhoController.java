                ...
                switch( acao )
                {
                    case "excluir":
                        if ( dao.excluir(idAparelho) ) {
                            ...
                            resposta.print("location.href='listAparelho.jsp';");
                        }
                        break;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // aparelho.setDescricao(request.getParameter("descricao"));
        ...
        if ( sucesso == true ) {
            ...
            resposta.print("<a href='listAparelho.jsp'>voltar</a>");
            // Consegui gravar
        } else {
            // Não consegui gravar
            resposta.print("<h1 style='color:red'> Erro ao salvar aparelho! </h1>");
